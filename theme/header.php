	...
	<header id="masthead" class="site-header" role="banner">
		<div class="max-w-7xl mx-auto px-4 md:px-8 py-4 flex justify-between items-center">
			...
			<div class="site-branding flex items-center gap-3">
				<?php $logo_url = iibpr_get( 'iibpr_logo' ); ?>
			...
			<!-- Navigation -->
			<nav id="site-navigation" class="main-navigation hidden md:flex items-center gap-4" aria-label="<?php esc_attr_e( 'Menu Principal', 'iibpr-theme' ); ?>">
				<?php
				wp_nav_menu( array(
				...
				<a href="https://wa.me/5561991572149" target="_blank" rel="noopener"
				   class="nav-aluno-btn inline-flex items-center gap-2 whitespace-nowrap flex-shrink-0">
