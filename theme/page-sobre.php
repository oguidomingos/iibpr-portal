...
<main id="main" class="site-main">
	...
	<section class="py-20 px-4 md:px-8 text-white text-center -mt-[72px] pt-[92px] relative overflow-hidden"
		...
		<div class="max-w-4xl mx-auto relative z-10">
			<h1 class="text-4xl md:text-5xl font-extrabold mb-4"><?php echo esc_html( iibpr_get( 'iibpr_sobre_hero_title', 'Quem Somos' ) ); ?></h1>
			<p class="text-xl opacity-90"><?php echo esc_html( iibpr_get( 'iibpr_sobre_hero_subtitle', 'Nossa história, missão e as pessoas por trás do IIBPR.' ) ); ?></p>
		</div>
	</section>
	...
	<section class="py-20 px-4 md:px-8 bg-white">
		<div class="max-w-5xl mx-auto">
			<div class="grid md:grid-cols-2 gap-12 items-center">
				<div>
					<p class="section-label"><?php echo esc_html( iibpr_get( 'iibpr_sobre_hist_label', 'Nossa História' ) ); ?></p>
					<h2 class="text-3xl font-extrabold text-gray-900 mt-2"><?php echo esc_html( iibpr_get( 'iibpr_sobre_hist_title', 'De Brasília para o Mundo' ) ); ?></h2>
					<div class="text-gray-600 text-lg leading-relaxed mt-4 space-y-4">
						<?php $t1 = iibpr_get( 'iibpr_sobre_hist_text_1' ); if ( $t1 ) : ?><p><?php echo wp_kses_post( $t1 ); ?></p><?php endif; ?>
						<?php $t2 = iibpr_get( 'iibpr_sobre_hist_text_2' ); if ( $t2 ) : ?><p><?php echo wp_kses_post( $t2 ); ?></p><?php endif; ?>
					</div>
				</div>
				<div>
		...
		<div class="max-w-5xl mx-auto">
			<div class="grid md:grid-cols-5 gap-8">
				<div class="md:col-span-3">
					<p class="section-label"><?php echo esc_html( iibpr_get( 'iibpr_sobre_wwd_label', 'O Que Fazemos' ) ); ?></p>
					<h2 class="text-3xl font-extrabold text-gray-900 mt-2 mb-6"><?php echo esc_html( iibpr_get( 'iibpr_sobre_wwd_title', 'Atendimento e Formação' ) ); ?></h2>
	...
	<section class="py-20 px-4 md:px-8 bg-white">
		<div class="max-w-4xl mx-auto">
			<div class="text-center mb-14">
				<p class="section-label"><?php echo esc_html( iibpr_get( 'iibpr_sobre_mvv_label', 'Propósito' ) ); ?></p>
				<h2 class="text-3xl font-extrabold text-gray-900 mt-2"><?php echo esc_html( iibpr_get( 'iibpr_sobre_mvv_heading', 'Missão, Visão e Valores' ) ); ?></h2>
			</div>
			<?php
			$mvv_icons = array(
			...
			<div class="grid md:grid-cols-3 gap-8">
				...
				<div class="bg-green-50 rounded-2xl p-8 border border-green-100">
					...
					<h3 class="text-xl font-bold text-gray-900 mb-3"><?php echo esc_html( iibpr_get( "iibpr_sobre_mvv_{$mi}_title", '' ) ); ?></h3>
					<p class="text-gray-600 leading-relaxed"><?php echo wp_kses_post( iibpr_get( "iibpr_sobre_mvv_{$mi}_text", '' ) ); ?></p>
				</div>
				<?php endfor; ?>
			</div>
		</div>
	...
	<section class="py-20 px-4 md:px-8 bg-gray-50">
		<div class="max-w-5xl mx-auto">
			...
			$mauro_book  = iibpr_get( 'iibpr_founder_3_book_image' );
			?>
			<div class="bg-white rounded-2xl shadow-sm p-8 md:flex md:items-center md:gap-10">
				...
				<div>
					...
					<p class="text-iibpr-green font-medium mb-3"><?php echo esc_html( iibpr_get( 'iibpr_founder_3_role', 'Diretor Científico — IIPR Itália' ) ); ?></p>
					<?php $mauro_bio = iibpr_get( 'iibpr_founder_3_bio_long' ); if ( $mauro_bio ) : ?>
					<p class="text-gray-600 leading-relaxed text-sm"><?php echo wp_kses_post( $mauro_bio ); ?></p>
					<?php endif; ?>
				</div>
				<?php if ( $mauro_book ) : ?>
				<div class="flex-shrink-0 hidden md:block">
					<img src="<?php echo esc_url( $mauro_book ); ?>" alt="Livro Prof. Mauro Vecchiato"
	...
	<section class="py-16 px-4 md:px-8 text-white relative overflow-hidden"
		...
		<div class="max-w-4xl mx-auto relative z-10">
			<div class="grid sm:grid-cols-2 md:grid-cols-4 gap-8 text-center">
				...
				<div>
					<div class="text-4xl font-extrabold"><?php echo esc_html( iibpr_get( "iibpr_sobre_stat_{$si}_number", '' ) ); ?></div>
					<div class="text-gray-300 mt-2"><?php echo esc_html( iibpr_get( "iibpr_sobre_stat_{$si}_label", '' ) ); ?></div>
				</div>
				<?php endfor; ?>
			</div>
		</div>
	...
	<section class="py-24 px-4 md:px-8 bg-gradient-to-br from-green-700 via-green-600 to-green-500 text-white text-center">
		<div class="max-w-3xl mx-auto">
			<h2 class="text-3xl md:text-4xl font-extrabold mb-6"><?php echo esc_html( iibpr_get( 'iibpr_sobre_cta_title', 'Faça Parte da Nossa História' ) ); ?></h2>
			<p class="text-xl opacity-90 mb-8"><?php echo wp_kses_post( iibpr_get( 'iibpr_sobre_cta_text', 'Conheça nossos cursos e formações em Psicomotricidade Relacional Psicodinâmica.' ) ); ?></p>
