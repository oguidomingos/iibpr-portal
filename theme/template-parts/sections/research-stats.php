...
<section id="pesquisa" class="section-padding relative overflow-hidden text-white"
         style="background-image: linear-gradient(135deg, rgba(64,72,86,0.92) 0%, rgba(58,90,42,0.88) 100%), url('<?php echo esc_url( $img_base . 'acao-grupo-4.jpg' ); ?>'); background-size: cover; background-position: center;">
	<div class="container-narrow relative z-10">
		...
		<div class="grid md:grid-cols-3 gap-8 text-center">
			...
			<div class="fade-up fade-up-delay-<?php echo $i + 1; ?>">
				<?php echo $stat['icon']; ?>
				<div class="stat-number counter-animate text-white <?php echo esc_attr( $stat['css'] ); ?>" data-target="<?php echo esc_attr( $stat['target'] ); ?>" data-suffix="<?php echo esc_attr( $stat['suffix'] ); ?>">
